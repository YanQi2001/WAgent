...
class NoteCard:
    ...
    def from_dict(cls, d: dict) -> NoteCard:
        ...
        for img in raw_images:
            ...
            if url:
                image_list.append({"url": url, "width": img.get("width", 0), "height": img.get("height", 0)})
        return cls(
            type=d.get("type", ""),
...
class Feed:
    ...
    def to_dict(self) -> dict:
        ...
        if self.note_card.image_list:
            result["imageList"] = self.note_card.image_list
        return result
